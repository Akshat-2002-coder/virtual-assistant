...
while(True): 
    ...
    if "exit" in query:
        ...
        speak("Sir your name is Akshat Bansal")
        ...
        try:
            speak("write the email id to which you want to send email")
            email = input()
        ...
        speak("to create a new folder please write the folder path name ")
        name = input()
        os.mkdir(name)
    elif "create a file" in query:
        speak("to create a new file please write the file path name ")
        f = open(input(),"w")
        f.close()
